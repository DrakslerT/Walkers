...
PRIMARY KEY (`ID_sprehod`, `ID_pes`, `ID_lastnik`, `ID_oglas`, `Tip_sprehajalec`, `Tip_lastnik`, `ID_sprehajalec`),
KEY `fkIdx_77` (`ID_pes`, `ID_lastnik`, `Tip_lastnik`),
KEY `fkIdx_81` (`ID_oglas`, `ID_sprehajalec`, `Tip_sprehajalec`)
) AUTO_INCREMENT=0;
...
ALTER TABLE `SPREHOD`
ADD CONSTRAINT `FK_76` FOREIGN KEY `fkIdx_77` (`ID_pes`, `ID_lastnik`, `Tip_lastnik`) REFERENCES `PES` (`ID_pes`, `ID_uporabnik`, `Tip`);
ALTER TABLE `SPREHOD`
ADD CONSTRAINT `FK_80` FOREIGN KEY `fkIdx_81` (`ID_oglas`, `ID_sprehajalec`, `Tip_sprehajalec`) REFERENCES `OGLAS` (`ID_oglas`, `ID_uporabnik`, `Tip`);
ALTER TABLE `SPREHOD`
